          ...
          <View style={globalStyle.marginTopValue}>
            ...
            <View style={globalStyle.listItem}>
              <View style={{ paddingBottom: 20 }}>
                ...
                <Text style={styles.property_label}>Full Name</Text>
                ...
                <Text style={styles.property_label}>Gender</Text>
                <Text style={styles.property_value}>{person.gender}</Text>

                <Text style={styles.property_label}>County</Text>
                <Text style={styles.property_value}>{person.school}</Text>

                <Text style={styles.property_label}>Form/Level</Text>
                <Text style={styles.property_value}>{person.formname}</Text>
                ...
                <Text style={globalStyle.slideTite}>
                  Subscription Information
                </Text>
                <Text style={styles.property_label}>Package</Text>
                <Text style={styles.property_value}>{subData.packname}</Text>

                <Text style={styles.property_label}>Subscription date</Text>
                <Moment
                  style={styles.property_value}
                  element={Text}
                  format="MMMM Do Y"
                ...
                <Text style={styles.property_label}>Subscription Expiry</Text>
                <Moment
                  style={styles.property_value}
                  element={Text}
                  format="MMMM Do Y"
